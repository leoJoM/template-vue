		...
		>
			<div class="card flex flex-wrap gap-4 w-full">
				...
				<div class="flex flex-col gap-2 flex-1">
					...
					>
						<label for="password"
							>Contraseña<span class="text-red-500"
								>*</span
							></label
						>
						<Password
			...
			<div class="card flex flex-wrap gap-4 w-full">
				<div class="flex flex-col gap-2 w-full">
					...
					>
						<label for="Nombre"
							>Nombre Completo<span class="text-red-500"
								>*</span
							></label
						>
						<InputText
			...
			<div class="card flex flex-wrap gap-4 w-full">
				<div class="flex flex-col gap-2 flex-1">
					...
					>
						<label for="Rol"
							>Tipo de Rol<span class="text-red-500"
								>*</span
							></label
						>
						<Select
				...
				<div class="flex flex-col gap-2 flex-1">
					...
					>
						<label for="departament"
							>Departamento<span class="text-red-500"
								>*</span
							></label
						>
						<Select
