...
<template>
	<div class="relative h-full w-full bg-gray-950">
		<div
					...
					<div class="p-8">
						...
						>
							...
							<div>
								<button
									type="submit"
									class="text-white w-full justify-center bg-blue-700 hover:bg-blue-800 transition duration-400 ease-in-out transform font-medium rounded-lg text-lg px-4 py-3 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
								>
									Iniciar sesión
									<svg
							...
							<div
								...
								id="alert-2"
								class="flex items-center p-4 mb-4 border border-red-500 rounded-lg bg-gray-800 text-red-500"
								role="alert"
							>
								<svg
